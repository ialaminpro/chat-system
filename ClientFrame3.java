...
public class ClientFrame3 extends Frame{
    public ClientFrame3(){
        setSize(500,500);
        ...
        add(new ClientPanel3(this), BorderLayout.CENTER);
        setVisible(true);
    }
...
class ClientPanel3 extends Panel implements ActionListener, Runnable {
    TextField tf;
    TextArea ta;
    List list;
    ...
    public ClientPanel3(Frame mainFrame){
